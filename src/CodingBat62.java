/*
Given a string and a second "word" string, we'll
        say that the word matches the string if it appears at the front of the string,
        ...
        startWord("hippo", "i") → "h"*/
public  class CodingBat62 {
    public static String startWord(String str, String word) {
        return str.length()<1?"":str.contains(word) || str.contains(word.substring(1))? str.substring(0, word.length()):"";
    }
